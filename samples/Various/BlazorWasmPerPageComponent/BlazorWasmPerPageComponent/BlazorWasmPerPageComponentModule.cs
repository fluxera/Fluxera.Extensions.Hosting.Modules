...
{
	using BlazorWasmPerPageComponent.Components;
	using BlazorWasmPerPageComponent.Contributors;
	...
	public sealed class BlazorWasmPerPageComponentModule : ConfigureApplicationModule
	{
		/// <inheritdoc />
